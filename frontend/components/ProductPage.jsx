...
export default function ProductPage({ productId }) {
    ...
    if (!product) return <div style={{ color: "white", padding: "100px" }}>Product not found.</div>;
            ...
            <div style={{ maxWidth: "1400px", margin: "100px auto 0", padding: "0 5%" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr 0.8fr", gap: "40px", alignItems: "start" }}>
                        ...
                        <div style={{ display: "flex", gap: "10px", marginTop: "16px", overflowX: "auto" }}>
                            {product.gallery.map((img, i) => (
                                <div key={i} onClick={() => setActiveImg(i)} style={{
                                    ...
                                    border: `2px solid ${activeImg === i ? c : "rgba(255,255,255,0.1)"}`,
                    ...
                    <div>
                        ...
                        <h1 style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: "36px", color: "#fff", lineHeight: 1.1, marginBottom: "8px" }}>
                            {product.name}
                        </h1>
                        ...
                        <h3 style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: "18px", color: "#fff", marginBottom: "12px" }}>About this item</h3>
                        <ul style={{ 
                    ...
                    <div style={{ 
                        ...
                        <div style={{ fontSize: "28px", color: "#fff", fontFamily: "'Rajdhani', sans-serif", fontWeight: 700, marginBottom: "12px" }}>
                            Bulk Inquiry
                        </div>
                        ...
                        <div style={{ marginBottom: "20px" }}>
                            <label style={{ display: "block", color: "#fff", fontSize: "13px", marginBottom: "8px", fontFamily: "'Inter', sans-serif" }}>Required Quantity (Meters)</label>
                            <div style={{ display: "flex", border: "1px solid rgba(255,255,255,0.2)", borderRadius: "4px" }}>
                                <button onClick={() => setQty(q => Math.max(10, q - 50))} style={{ background: "rgba(255,255,255,0.05)", border: "none", color: "#fff", padding: "12px", cursor: "pointer" }}>-</button>
                                <input type="number" value={qty} onChange={e => setQty(Number(e.target.value))} style={{ width: "100%", background: "transparent", border: "none", color: "#fff", textAlign: "center", outline: "none", fontSize: "16px" }} />
                                <button onClick={() => setQty(q => q + 50)} style={{ background: "rgba(255,255,255,0.05)", border: "none", color: "#fff", padding: "12px", cursor: "pointer" }}>+</button>
                            </div>
                        </div>
                        ...
                        <div style={{ marginTop: "24px", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "16px", fontSize: "12px", color: "var(--muted)", display: "flex", flexDirection: "column", gap: "8px" }}>
                ...
                <div style={{ marginTop: "80px", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "60px" }}>
                    <h2 style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: "28px", color: "#fff", marginBottom: "32px" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "20px" }}>
                        {related.map(r => (
                            <a href={`/product/${r.id}`} key={r.id} style={{
                                textDecoration: "none", background: "var(--card)", border: "1px solid rgba(255,255,255,0.05)", padding: "24px",
                            ...
                            onMouseLeave={e => e.currentTarget.style.transform = "translateY(0)"}>
                                ...
                                <div style={{ color: "#fff", fontSize: "20px", fontFamily: "'Rajdhani', sans-serif", fontWeight: 700, marginTop: "12px" }}>Request Quote</div>
                            </a>
                        ))}
                    </div>
                </div>
